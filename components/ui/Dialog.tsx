...
const classnames = {
  ...
  content: "fixed data-[state=open]:animate-scale-in data-[state=closed]:animate-scale-out left-1/2 z-[999] top-1/2 max-h-[100vh] min-w-[360px] max-w-[calc(100%-12%)] lg:max-w-2xl -translate-x-1/2 -translate-y-1/2 rounded-2xl bg-black border border-muted/40"
}
