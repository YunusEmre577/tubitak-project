...
export default function Footer() {
  return (
    <footer className='p-8 pt-12 relative overflow-hidden px-8 bg-secondary/20 border-t border-t-accent lg:px-16 flex flex-wrap justify-center lg:justify-between gap-12'>
        <div className='bottom-0 absolute h-40 w-[1000px] bg-colored pointer-events-none left-1/2 -translate-x-1/2 blur-[600px]'></div>
        ...
        <section className='flex flex-col gap-5'>
          <span className='font-medium text-lg lg:text-lg'>Sayfalar</span>
        ...
        <section className='flex flex-col gap-5'>
          <span className='font-medium text-lg lg:text-lg'>Kaynak</span>
          <nav className='flex flex-col gap-1'>
        ...
        <section className='flex flex-col gap-5'>
          <span className='font-medium text-lg lg:text-lg'>İletişim</span>
          <nav className='flex flex-col gap-1'>
            <Link className='text-muted hover:underline' target="_blank" href={"/"}>İnstagram</Link>
            <Link className='text-muted hover:underline' target="_blank" href={"/"}>Twitter</Link>
            <Link className='text-muted hover:underline' target="_blank" href={"/"}>Youtube</Link>
            <Link className='text-muted hover:underline' target="_blank" href={"/"}>Github</Link>
            <Link className='text-muted hover:underline' target="_blank" href={"/"}>Whatsapp</Link>
          </nav>
        </section>
