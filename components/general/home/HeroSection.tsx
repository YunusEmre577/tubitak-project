...
export default function HeroSection() {
  return (
    <section className="w-full responsive flex flex-col pt-24 lg:pt-32 items-center">
...
<Button variant="ghost" icon="solar:arrow-down-outline" className="text-muted w-full lg:w-fit">Aşağı in</Button>
</Link>
    </div>
    </div>
  </section>
